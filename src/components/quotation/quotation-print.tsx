...
export type QuotationPrintProps = {
...
export function QuotationPrintView(props: QuotationPrintProps) {
    ...
    <div className={theme.shell}>
      ...
      >
        ...
        <div className="text-right text-sm">
          ...
          <p className="text-slate-600">
            Valid until: <span className="text-slate-900">{formatDateDdMmYyyy(props.validUntil)}</span>
          </p>
          <p className="text-slate-600">
      ...
      <div className="mt-6 grid gap-4 md:grid-cols-2">
        <div>
          <div className={`border-b pb-1 text-sm font-semibold ${theme.partyRule}`}>Bill to (customer)</div>
