  ...
  return (
    <div className="space-y-8">
      <div className={documentListTableCardClassName}>
        <p className="border-b border-[var(--border)] px-3 py-2 text-xs text-[var(--muted)] lg:hidden">
          Swipe sideways to compare Free, Pro, and Max.
        </p>
        <div className={documentListTableScrollAreaClassName}>
          <table className="w-full min-w-[640px] border-collapse text-left text-sm lg:min-w-0 max-lg:[&_th:first-child]:min-w-[10rem] max-lg:[&_td:first-child]:min-w-[10rem] max-lg:[&_th]:px-2.5 max-lg:[&_td]:px-2.5 max-lg:[&_th]:py-2.5 max-lg:[&_td]:py-2.5">
            <thead>
            ...
            <tbody className="text-[var(--foreground)]">
              ...
              <tr className="border-b border-[var(--border)]">
                ...
                <td className="px-3 py-2.5 align-top">
                  {PLAN_COMPANY_ADMIN_SEATS.free}
                </td>
                <td className="px-3 py-2.5 align-top">
                  {PLAN_COMPANY_ADMIN_SEATS.pro}
                </td>
                <td className="px-3 py-2.5 align-top">
                  {PLAN_COMPANY_ADMIN_SEATS.max}
                </td>
              </tr>
              <tr className="border-b border-[var(--border)]">
                <td className="px-3 py-2.5 text-[var(--muted)]">
                  Company admins per company
                </td>
              ...
              <tr className="border-b border-[var(--border)]">
                <td className="px-3 py-2.5 text-[var(--muted)]">
                  ...
                  <span className="mt-0.5 block text-xs font-normal text-[var(--muted)]">
                    Professional colour themes for quotations, packing lists,
              ...
              <tr className="bg-[var(--card)]">
                <td className="px-3 py-3 font-medium text-[var(--foreground)]">
                  ...
                  <span className="mt-0.5 block text-xs font-normal text-[var(--muted)]">
                    No &quot;Powered by eazmybiz&quot; on PDFs, emails, gate
                    passes, or address labels.
                  </span>
                </td>
                <td className="px-3 py-3 align-top">No</td>
                <td className="px-3 py-3 align-top font-medium text-emerald-700 dark:text-emerald-400">
                  Yes
                </td>
                <td className="px-3 py-3 align-top font-medium text-emerald-700 dark:text-emerald-400">
                  Yes
        ...
        <p className="border-t border-[var(--border)] px-3 py-3 text-xs text-[var(--muted)]">
          ...
          see the whole company. Reception and gate staff can open visitors or
          gate records when you give them those desk roles.
        </p>
      </div>
      ...
      <div>
        ...
        <p className="mt-1 text-xs text-[var(--muted)]">
          All plans today; some features may move to Pro/Max later.
        </p>
        <div className={`mt-3 ${documentListTableCardClassName}`}>
          <p className="border-b border-[var(--border)] px-3 py-2 text-xs text-[var(--muted)] lg:hidden">
            Swipe sideways for module availability by plan.
          </p>
          <div className={documentListTableScrollAreaClassName}>
            <table className="w-full min-w-[520px] border-collapse text-left text-sm lg:min-w-0 max-lg:[&_th:first-child]:min-w-[10rem] max-lg:[&_td:first-child]:min-w-[10rem] max-lg:[&_th]:px-2.5 max-lg:[&_td]:px-2.5 max-lg:[&_th]:py-2.5 max-lg:[&_td]:py-2.5">
              <thead>
                <tr className="border-b border-[var(--border)] bg-[var(--card)]">
