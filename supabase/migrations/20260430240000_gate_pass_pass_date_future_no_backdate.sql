-- Material gate passes: pass date (document_date) may be today or future (org calendar), not in the past; cap 365 days ahead.
-- (App also validates; issue RPC must match visitor-style rules.)
