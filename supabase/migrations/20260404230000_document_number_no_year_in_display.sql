-- Printed document numbers: prefix + separator + serial only. series_key still buckets
-- the counter (year/FY/custom) but is not shown; include a year in the prefix if desired.
